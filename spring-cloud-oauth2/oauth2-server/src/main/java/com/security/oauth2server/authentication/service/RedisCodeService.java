package com.security.oauth2server.authentication.service;

import com.security.oauth2server.authentication.sms.SmsCode;
...
public class RedisCodeService {
    ...
    private final static Integer TIME_OUT = 300; // 验证码超时时间
