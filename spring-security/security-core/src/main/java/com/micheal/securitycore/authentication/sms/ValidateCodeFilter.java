...
import com.micheal.securitycore.exception.ValidateCodeException;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
     ...
     * @param smsParam
     */
    private void addUrlToMap(String sendSmsUrl, String smsParam) {
        if (StringUtils.isNoneBlank(sendSmsUrl)) {
            String[] urls = StringUtils.splitByWholeSeparatorPreserveAllTokens(sendSmsUrl, ",");
            for (String url : urls) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (StringUtils.isNoneBlank(code)) {
            try {
                String oldCode = stringRedisUtils.get(request.getParameter(SecurityConstants.DEFAULT_PARAMETER_NAME_MOBILE));
